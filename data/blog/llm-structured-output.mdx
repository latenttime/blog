...
layout: PostBanner
images: ['/static/images/logprobs/banner.png']
---
...
<Image alt="the cat sat on the" src="/static/images/logprobs/0.png" width={1000} height={500} />
...
and generate [JSON Schema](https://json-schema.org/)

```
{'properties': {'animal': {'title': 'Animal', 'type': 'string'}}, 'required': ['animal'], 'title': 'Animal', 'type': 'object'}
```

which we can use to call the LLM using function calling
...
<Image alt="1" src="/static/images/logprobs/1.png" width={1000} height={500} />
...
<Image alt="2" src="/static/images/logprobs/2.png" width={1000} height={500} />
...
<Image alt="3" src="/static/images/logprobs/3.png" width={1000} height={500} />
...
<Image alt="4" src="/static/images/logprobs/4.png" width={1000} height={500} />
...
<Image alt="5" src="/static/images/logprobs/5.png" width={1000} height={500} />
