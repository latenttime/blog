...
date: '2024-05-06'
tags: ['2024', 'llm', 'vlm', 'vit', 'theory', 'cv', 'transformers']
draft: false
summary: Building a Vision Language Model (VLM) with an LLM + Vision Encoder.
---
...
> <Image alt="human eye" src="/static/images/human-eye.png" width={500} height={350} />
...
|             | R                                                               | G                                                               | B                                                               | Total                                                           |
| :---------- | :-------------------------------------------------------------- | :-------------------------------------------------------------- | :-------------------------------------------------------------- | :-------------------------------------------------------------- |
| **Color**   | ![#3B0000](https://via.placeholder.com/25/3B0000/000000?text=+) | ![#008E00](https://via.placeholder.com/25/008E00/000000?text=+) | ![#0000A4](https://via.placeholder.com/25/0000A4/000000?text=+) | ![#3B8EA4](https://via.placeholder.com/25/3B8EA4/000000?text=+) |
| **Decimal** | 59                                                              | 142                                                             | 164                                                             | (59, 142, 164)                                                  |
| **Binary**  | 00111011                                                        | 10001110                                                        | 10100100                                                        | 00111011 10001110 10100100                                      |
| **Hex**     | 0x3B                                                            | 0x8E                                                            | 0xA4                                                            | #3B8EA4                                                         |
...
<Image alt="resize & flatten" src="/static/images/flatten.png" width={800} height={600} />
...
<Image alt="nn" src="/static/images/nn.png" width={500} height={300} />
...
<Image alt="lionfish resized" src="/static/images/lionfish_resized.png" width={224} height={224} />
...
<Image alt="patch grid" src="/static/images/patch_grid.png" width={224} height={224} />
...
<Image alt="vlm" src="/static/images/vlm.png" width={640} height={640} />
...
Kudos to the HF team, this is an awesome asset for the VLM community! 🤗
...
Finally, we saw how we can fuse LLM and VE backbones to create a vision capable LLM, a VLM.
